...
export default function EventWedding() {
  ...
  return (
    ...
    >
      <div
        className="bg-image"
        style={{ backgroundImage: `url('images/bg2.jpg')`, height: 700 }}
      />
      <div className="absolute text-center z-10 left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-4 p-8 gap-4 -translate-y-1/2">
        {events.map((event, index) => (
          <div
            className="p-4 bg-white text-center rounded-lg overflow-hidden"
            key={index}
          >
